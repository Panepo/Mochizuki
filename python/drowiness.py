...
from utils.draw import drawLandmarks, drawDrowiness
from utils.drowiness import eyeAspectRatio

############ Add argument parser for command line arguments ############
parser = argparse.ArgumentParser(
    description="Drowsiness detection demo with OpenCV, dlib and face_recognition libraries."
)
parser.add_argument(
    "--input",
...
def main():
    ...
    kWinName = "Drowsiness detection demo"
    ...
    while cv.waitKey(1) < 0:
        ...
        for face_landmark in face_landmarks:
            ...
            face_drowiness.append(earLeft + earRight)

        # Display the results
        drawDrowiness(frame, face_locations, face_drowiness, args.scale)
